...
export default {
  ...
  mounted: function () {
    ...
    L.marker([-37.800224, 144.958295]).addTo(mymap);
    //healthsmart chemist
    L.marker([-37.798817, 144.955548]).addTo(mymap);
    //melbourne central pharmacy
    L.marker([-37.809833, 144.963583]).addTo(mymap);

    L.circle([-37.8, 144.97], {
      color: "red",
      fillColor: "#f03",
      fillOpacity: 0.5,
      radius: 500,
